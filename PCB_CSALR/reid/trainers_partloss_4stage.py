...
class BaseTrainer(object):
    ...
    def train(self, epoch, data_loader, optimizer, print_freq=1):
        ...
        for i, inputs in enumerate(data_loader):
            ...
            # torch.autograd.backward([loss0, loss1, loss2, loss3, loss4, loss5, loss6,loss_layer1,loss_layer2,loss_layer3,loss_sa],
            ...
            # torch.autograd.backward([loss0, loss1, loss2, loss3, loss4, loss5, loss6],
            #                         [torch.ones(1).cuda(), torch.ones(1).cuda(), torch.ones(1).cuda(),torch.ones(1).cuda(),torch.ones(1).cuda(),
