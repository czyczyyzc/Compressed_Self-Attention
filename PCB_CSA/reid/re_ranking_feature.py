...
# feature_path = '/home/tfboys/whr/DARENet-master/feature/original/Market1501'
# probFea = scipy.io.loadmat(osp.join(feature_path, "query_features.mat"))['feature_query_new'].T
# galFea = scipy.io.loadmat(osp.join(feature_path, "test_features.mat"))['feature_test_new'].T
# k1 = 20
# k2 = 6
# lambda_value = 0.3
# final_dist = re_ranking(probFea,galFea,k1,k2,lambda_value)
# np.save('final_distmat.npy',final_dist)
